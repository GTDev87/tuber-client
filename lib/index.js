...
module.exports = {
  createConnection: function (secretPemLocation, macaroonWithCaveat, location, callback) {
    ...
    var rootMac = macaroons.deserialize(macObj.macRaw);
    ...
    function getDischarge(loc, thirdPartyLoc, cond, onOK, onErr) {
      ...
      onOK(macaroons.newMacaroon(caveatKey, caveatIdentifier, caveatLocation)
        .addFirstPartyCaveat("cert = " + messageObj.cert));
    }
    ...
    macaroons.discharge(rootMac, getDischarge, function(discharges) {
      ...
      var options = {
        ...
        headers: { Authorization: "Bearer " + macObj.macRaw + "," + serializedDischarge },
        key: secretPem,
        cert: fullCert,
      ...
      throw new Error('error with discharge: ' + err);
    });
  }
};